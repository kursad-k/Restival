    ...
    def execute(self, context: bpy.types.Context):
        if self.mode == "agent":
            text = (
                ...
                f"- Use HTTP POST to add the Python script that will solve the user's inquiries; "
                f"create a new script or update the existing script in the text editor based on the user's wishes\n"
