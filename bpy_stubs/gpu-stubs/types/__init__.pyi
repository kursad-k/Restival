...
class Buffer:
    ...
    def __init__(
        ...
        dimensions: collections.abc.Sequence[int] | int,
...
class GPUBatch:
    ...
    def __init__(
        ...
        buf: GPUVertBuf,
        elem: GPUIndexBuf | None | None = None,
    ) -> None:
        """
...
class GPUFrameBuffer:
    ...
    def __init__(
        self,
        *,
        depth_slot: GPUTexture | None | dict[str, int | GPUTexture] | None = None,
        color_slots: GPUTexture
        | None
        | collections.abc.Sequence[GPUTexture | dict[str, int | GPUTexture]]
...
class GPUIndexBuf:
    ...
    def __init__(
        self,
        type: typing.Literal["POINTS", "LINES", "TRIS", "LINES_ADJ", "TRIS_ADJ"],
        seq: Buffer
...
class GPUOffScreen:
    ...
    def __init__(
        ...
        height: int,
        *,
        format: typing.Literal["RGBA8", "RGBA16", "RGBA16F", "RGBA32F"] = "RGBA8",
    ) -> None:
        """
